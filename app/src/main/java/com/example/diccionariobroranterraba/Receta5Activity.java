...
public class Receta5Activity extends AppCompatActivity implements RecyclerAdapter.itemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.receta5Recycler);
    ...
    public void itemClick(int position) {
        ...
        if (result == mAudioManager.AUDIOFOCUS_REQUEST_GRANTED){
            mMediaPlayer = MediaPlayer.create(Receta5Activity.this, imageAndSoundModel.getmAudioResourceID());
        }
        mMediaPlayer.start();
